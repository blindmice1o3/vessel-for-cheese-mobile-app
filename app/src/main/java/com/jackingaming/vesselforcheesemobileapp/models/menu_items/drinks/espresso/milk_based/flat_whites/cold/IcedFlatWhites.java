...
public abstract class IcedFlatWhites extends MilkBased {
    ...
    public IcedFlatWhites(String name, String description, int calories, int sugarInGram, float fatInGram,
