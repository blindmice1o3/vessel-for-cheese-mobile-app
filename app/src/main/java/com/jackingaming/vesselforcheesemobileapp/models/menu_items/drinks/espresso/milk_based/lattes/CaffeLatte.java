...
//    public static final Map<Liquid.Type, DEFAULT_LIQUID =
    ...
    public CaffeLatte() {
        ...
        // TODO: replace with Map<String, List<DrinkComponent>
        // MILK_OPTIONS (whatsIncluded)
        ...
        // ESPRESSO_OPTIONS (whatsIncluded)
        ...
        drinkComponentsDefault.put(MilkOptions.TAG, milkOptionsDefault);
        drinkComponentsDefault.put(EspressoOptions.TAG, espressoOptionsDefault);
    }
}
